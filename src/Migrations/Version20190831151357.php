 ...
 */
final class Version20190831151357 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE option_command_details (option_id INT NOT NULL, command_details_id INT NOT NULL, INDEX IDX_516E291A7C41D6F (option_id), INDEX IDX_516E2912C4FEFE5 (command_details_id), PRIMARY KEY(option_id, command_details_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE command_details ADD reservation_start DATE NOT NULL, ADD reservation_end DATE NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE command_details DROP reservation_start, DROP reservation_end');
    }
}
