...
";
    ...
    <p id=\"<?php echo \$view->escape(\$id); ?>_help\" <?php echo ' '.\$view['form']->block(\$form, 'attributes', ['attr' => \$help_attr]); ?>><?php echo \$help; ?></p>
<?php endif; ?>
", "FrameworkBundle:Form:form_help.html.php", "/Applications/MAMP/htdocs/camping_project/vendor/symfony/framework-bundle/Resources/views/Form/form_help.html.php");
    }
}
