...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "WebProfilerBundle:Collector:validator.html.twig", "/Applications/MAMP/htdocs/camping_project/vendor/symfony/web-profiler-bundle/Resources/views/Collector/validator.html.twig");
    }
}
