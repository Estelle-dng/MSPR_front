...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "SecurityBundle:Collector:security.html.twig", "/Applications/MAMP/htdocs/camping_project/vendor/symfony/security-bundle/Resources/views/Collector/security.html.twig");
    }
}
