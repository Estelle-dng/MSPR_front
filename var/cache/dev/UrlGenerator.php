...
return [
    ...
    'listeInfos' => [[], ['_controller' => 'App\\Controller\\Admin\\AdminInfosController::listeinfos'], [], [['text', '/admin/listeinfos']], [], []],
    'admin.listeinfos.create' => [[], ['_controller' => 'App\\Controller\\Admin\\AdminInfosController::create'], [], [['text', '/admin/listeinfos/create']], [], []],
    'admin.info.edit' => [['id'], ['_controller' => 'App\\Controller\\Admin\\AdminInfosController::edit'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/admin/listeInfos']], [], []],
    'admin.info.delete' => [['id'], ['_controller' => 'App\\Controller\\Admin\\AdminInfosController::delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/admin/listeInfos']], [], []],
    ...
    'listeUrgences' => [[], ['_controller' => 'App\\Controller\\Admin\\AdminUrgencesController::listeurgences'], [], [['text', '/admin/listeurgences']], [], []],
    'admin.listeurgences.create' => [[], ['_controller' => 'App\\Controller\\Admin\\AdminUrgencesController::create'], [], [['text', '/admin/listeurgences/create']], [], []],
    'admin.urgence.edit' => [['id'], ['_controller' => 'App\\Controller\\Admin\\AdminUrgencesController::edit'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/admin/listeUrgences']], [], []],
    'admin.urgence.delete' => [['id'], ['_controller' => 'App\\Controller\\Admin\\AdminUrgencesController::delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/admin/listeUrgences']], [], []],
    'Dashboard' => [[], ['_controller' => 'App\\Controller\\Admin\\HomeController::Dashboard'], [], [['text', '/admin/Dashboard']], [], []],
    'addphoto' => [[], ['_controller' => 'App\\Controller\\Admin\\HomeController::Addphoto'], [], [['text', '/addphoto']], [], []],
